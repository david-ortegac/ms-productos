...
public class SearchCriteria<ProductsJPA> implements Specification<ProductsJPA> {
    ...
    @Override
    public Predicate toPredicate(Root<ProductsJPA> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
